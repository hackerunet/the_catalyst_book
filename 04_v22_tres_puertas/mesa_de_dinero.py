...
# --- V22: nombres internos actualizados (referencias de log + servicio objetivo) ---
LOG_FILE = 'v22_live.log'
SIMULADOR_TARGET = "simulador_institucional_v22.py"
...
def send_telegram(mensaje, reply_markup=None):
    ...
    payload = {"chat_id": TELEGRAM_TARGET, "text": f"[V22_MASTER] {mensaje}"}
    if reply_markup:
...
def telegram_polling():
    ...
    print("MESA DE DINERO V22: Iniciando polling interactivo de Telegram...")
    while True:
        try:
                ...
                for update in data['result']:
                    ...
                    if 'callback_query' in update:
                        ...
                        if cb_data.startswith("close_trade|"):
                            ...
                            try:
                                # V22 corre su dashboard/API en el puerto 8054 (8053 sigue ocupado por V21 en paralelo)
                                r = requests.post("http://127.0.0.1:8054/api/close_trade", json={'symbol': symbol}, timeout=5)
...
def run_mesa():
    log_diario("MESA DE DINERO V22: Inicializando servicio autónomo (Capa de Régimen Adaptativo).")
    send_telegram(
        "🚀 V22 OPERATIVA — Capa de Régimen Adaptativo\n"
    ...
    while True:
        print(f"MESA DE DINERO V22: Iniciando proceso de {SIMULADOR_TARGET}...")
        ...
        while True:
            ...
            #     puerta y por régimen (la pieza clave para "determinar la mejor estrategia").
                ...
                try:
                    ...
                    bloques = [
                        f"{icono_resultado} RESULTADOS DEL BACKTEST HISTÓRICO — V22\n"
