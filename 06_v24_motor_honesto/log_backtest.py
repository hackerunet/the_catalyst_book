#!/usr/bin/env python3
"""
Framework de tracking de experimentos para V24-FABLE.

Lee la ultima linea ALERTA_BACKTEST_RESUMEN_FIXED de mesa_v24.out, la combina
...
NOTA V24: backtest_history.csv arranca VACIO en esta carpeta a proposito —
los numeros del motor V24 (reloj global + intravela pesimista + costos
completos) NO son comparables con las filas historicas de V22.
...
LOG_FILE = os.path.join(os.path.dirname(__file__), 'mesa_v24.out')
