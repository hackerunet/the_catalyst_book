...
from estrategia_v18_B import compute_indicators, compute_signals_and_trades, INTERVAL
    ...
    for t in sim_state['trades']:
        ...
        if t['status'] == 'ABIERTA':
            ...
            if t['type'] == 'LONG':
                ...
                # Trailing Stop Update (2.5x ATR desde el máximo alcanzado)
                if current_atr > 0:
                    trailing_sl = t['highest_price'] - (current_atr * 2.5)
                else:
                ...
                # Trailing Stop Update (2.5x ATR desde el mínimo alcanzado)
                if current_atr > 0:
                    trailing_sl = t['lowest_price'] + (current_atr * 2.5)
                else:
