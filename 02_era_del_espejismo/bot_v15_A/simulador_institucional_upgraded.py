        ...
        if t['status'] == 'ABIERTA':
            ...
            if t['type'] == 'LONG':
                ...
                if candle['low'] <= t['sl']:
                    ...
                    t['exit_time'] = candle['time']
                    t['exit_price'] = t['tp']
                    t['exit_reason'] = 'TAKE PROFIT (1:2 R:R)'
                    t['pnl'] = (t['exit_price'] - t['entry_price']) * t['qty']
                    sim_state['balance'] += t['pnl']
                    if is_ready: print(f"ALERTA_CIERRE|{t['type']}|{symbol}|{t['tp']:.4f}|+{t['pnl']:.4f}|{sim_state['balance']:.4f}", flush=True)
            ...
            if t['type'] == 'LONG':
                ...
                trailing_sl = candle['close'] - (1.5 * current_atr)
