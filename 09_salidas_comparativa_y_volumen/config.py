...
# ============================================================================
# V69 (2026-07-11) — TRAILING POR INDICADOR sobre EXIT_MODE='tendencia'. Los
# tres trailing que admití NO haber corrido (conversación del Cap.30). Cada uno
# ratchetea el SL de protección hacia un nivel-indicador al CIERRE de la vela
# (SL = max(SL, nivel) LONG / min SHORT), nunca afloja, efectivo desde la vela
# siguiente (patrón anti-lookahead de V31). El flip y el stop original siguen
# activos. Un solo flag a la vez. Parámetros canónicos, NO escaneados.
# ============================================================================
# T1: VWAP anclado desde la entrada (precio típico HLC/3 ponderado por volumen).
TRAIL_VWAP_TENDENCIA = False
# T2: EMA fija idéntica en todos los símbolos (per-símbolo = curve-fit, V68).
TRAIL_EMA_TENDENCIA = False
TRAIL_EMA_SPAN = 20
# T3: "caimanada" — SL = mínimo/máximo de la vela diaria COMPLETADA anterior
# (TF superior = 1 día para base 4h; N=1; columna causal Prev_Daily_Low/High).
TRAIL_SWING_HTF_TENDENCIA = False
