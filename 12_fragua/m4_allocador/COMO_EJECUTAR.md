...
## Ejecutar
```bash
cd Fragua/m4_allocador
python3 run_v41.py
```

## Qué esperar
Script(s) de investigación: run_v41.py, run_v42_v43.py. Cada uno reproduce un estudio del libro. Ver comentarios de cabecera.
