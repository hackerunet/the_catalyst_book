# Cómo ejecutar — `m2_pairs_trading`
...
## Ejecutar
```bash
cd Fragua/m2_pairs_trading
python3 run_v47.py
```

## Qué esperar
Script(s) de investigación: run_v47.py. Cada uno reproduce un estudio del libro. Ver comentarios de cabecera.
