...
async def peticion_firmada_async(method, endpoint, params):
    url_base = f"https://demo-fapi.binance.com/fapi/v1/{endpoint}"
    q = urlencode(params)
...
async def cerrar_orden_binance(symbol, tipo_orden, qty):
    """
