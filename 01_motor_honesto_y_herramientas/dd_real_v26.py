...
# NOTA (repo del libro): el dial de copy-trade (CLI que escanea el nivel de riesgo
# contra el gate de MDD-90 días de Binance) queda en reserva y no se publica.
# Este módulo se conserva solo por sus helpers de equity mark-to-market
# (equity_markto_market / max_dd / peor_dd_rolling), que usan otros estudios del
# libro (oracle_exit_v26, giveback_analisis).
